package com.atpn.TriggerHotel.service.impl;

import com.atpn.TriggerHotel.dto.Response;
import com.atpn.TriggerHotel.dto.RoomDTO;
import com.atpn.TriggerHotel.entity.Room;
import com.atpn.TriggerHotel.exception.OurException;
import com.atpn.TriggerHotel.repo.BookingRepository;
import com.atpn.TriggerHotel.repo.RoomRepository;
import com.atpn.TriggerHotel.service.AwsS3Service;
import com.atpn.TriggerHotel.service.RoomService;
import com.atpn.TriggerHotel.utils.Utils;
...
public class RoomServiceImpl implements RoomService {
    ...
    public Response addNewRoom(MultipartFile photo, String roomType, BigDecimal roomPrice, String description) {
        ...
        try {
            ...
            response.setMessage("Add a new room successful");
    ...
    public Response getAllRooms() {
        ...
        try {
            ...
            response.setStatusCode(200);
            response.setMessage("Get all rooms successful");
    ...
    public Response getAvailableRoomsByDataAndType(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        ...
        try {
            ...
            response.setStatusCode(200);
            response.setMessage("Get available room successful");
            response.setRoomList(roomDTOList);
