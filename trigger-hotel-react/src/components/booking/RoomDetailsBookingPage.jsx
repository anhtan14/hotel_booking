...
const RoomDetailsBookingPage = () => {
  ...
  const handleConfirmBooking = async () => {
    //Check if the room was selected dates
    ...
    //Check if number of adults and children is valid
    if (
      isNaN(numAdults) ||
      numAdults < 1 ||
      isNaN(numChildren) ||
    ...
    <div className="room-details-booking">
      {showMessage && (
        <p className="booking-success-message">
          Booking successful! Your confirmation code is {confirmationCode}. An
          email with your booking details has been sent to you.
        </p>
      )}
      ...
      {bookings && bookings.length > 0 && (
        <div>
          <h3>Existing Bookings Details</h3>
